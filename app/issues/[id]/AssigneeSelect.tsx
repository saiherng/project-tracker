...
const AssigneeSelect = ({issue} : {issue: Issue}) => {
  ...
  if (userId === issue.assignedToUserId || (!userId && !issue.assignedToUserId)) return;
  ...
  return (
    <Select.Root defaultValue={issue.assignedToUserId || 'unassigned'} onValueChange={handleValueChange}>
